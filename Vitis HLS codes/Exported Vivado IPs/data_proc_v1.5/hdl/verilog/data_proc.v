...
(* CORE_GENERATION_INFO="data_proc_data_proc,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu28dr-ffvg1517-2-e,HLS_INPUT_CLOCK=6.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.007000,HLS_SYN_LAT=1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=10,HLS_SYN_LUT=118,HLS_VERSION=2022_1}" *)
...
output  [0:0] out_stream_TLAST;
 ...
 reg    ap_rst_n_inv;
reg   [7:0] data_count_V;
reg    in_stream_TDATA_blk_n;
(* fsm_encoding = "none" *) reg   [1:0] ap_CS_fsm;
wire    ap_CS_fsm_state1;
reg    out_stream_TDATA_blk_n;
wire    ap_CS_fsm_state2;
reg   [63:0] ap_phi_mux_output_word_data_V_phi_fu_95_p6;
reg    ap_predicate_op18_read_state1;
reg    ap_block_state1;
wire   [7:0] ret_V_fu_162_p3;
wire   [7:0] add_ln1560_fu_144_p2;
wire   [0:0] icmp_ln232_fu_150_p2;
wire   [7:0] add_ln232_fu_156_p2;
reg   [1:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if ((~((out_stream_TREADY_int_regslice == 1'b0) | ((ap_predicate_op18_read_state1 == 1'b1) & (in_stream_TVALID_int_regslice == 1'b0))) & (1'b1 == ap_CS_fsm_state1))) begin
        data_count_V <= ret_V_fu_162_p3;
    end
end

always @ (*) begin
    if (((out_stream_TREADY_int_regslice == 1'b0) | ((ap_predicate_op18_read_state1 == 1'b1) & (in_stream_TVALID_int_regslice == 1'b0)))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        if ((data_count_V == 8'd0)) begin
            ap_phi_mux_output_word_data_V_phi_fu_95_p6 = 64'd65535;
        end else if ((data_count_V == 8'd1)) begin
            ap_phi_mux_output_word_data_V_phi_fu_95_p6 = 64'd18446744072350466048;
        end else if ((~(data_count_V == 8'd1) & ~(data_count_V == 8'd0))) begin
            ap_phi_mux_output_word_data_V_phi_fu_95_p6 = in_stream_TDATA_int_regslice;
        end else begin
            ap_phi_mux_output_word_data_V_phi_fu_95_p6 = 'bx;
        end
    end else begin
        ap_phi_mux_output_word_data_V_phi_fu_95_p6 = 'bx;
    end
...
always @ (*) begin
    if ((~(data_count_V == 8'd1) & ~(data_count_V == 8'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((out_stream_TREADY_int_regslice == 1'b0) | ((ap_predicate_op18_read_state1 == 1'b1) & (in_stream_TVALID_int_regslice == 1'b0))) & (ap_predicate_op18_read_state1 == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln1560_fu_144_p2 = (data_count_V + 8'd1);

assign add_ln232_fu_156_p2 = (data_count_V + 8'd77);
...
always @ (*) begin
    ap_block_state1 = ((out_stream_TREADY_int_regslice == 1'b0) | ((ap_predicate_op18_read_state1 == 1'b1) & (in_stream_TVALID_int_regslice == 1'b0)));
end
...
always @ (*) begin
    ap_predicate_op18_read_state1 = (~(data_count_V == 8'd1) & ~(data_count_V == 8'd0));
end
...
assign icmp_ln232_fu_150_p2 = ((add_ln1560_fu_144_p2 < 8'd180) ? 1'b1 : 1'b0);

assign in_stream_TREADY = regslice_both_in_stream_V_data_V_U_ack_in;

assign out_stream_TLAST_int_regslice = ((data_count_V == 8'd179) ? 1'b1 : 1'b0);

assign out_stream_TVALID = regslice_both_out_stream_V_data_V_U_vld_out;

assign ret_V_fu_162_p3 = ((icmp_ln232_fu_150_p2[0:0] == 1'b1) ? add_ln1560_fu_144_p2 : add_ln232_fu_156_p2);
