...
architecture behav of data_proc is 
    ...
    "data_proc_data_proc,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu28dr-ffvg1517-2-e,HLS_INPUT_CLOCK=6.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=2.007000,HLS_SYN_LAT=1,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=11,HLS_SYN_LUT=118,HLS_VERSION=2022_1}";
    ...
    constant ap_const_lv64_FEAE00000000 : STD_LOGIC_VECTOR (63 downto 0) := "0000000000000000111111101010111000000000000000000000000000000000";
    ...
    signal ret_V_fu_144_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal add_ln1560_fu_126_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal icmp_ln232_fu_132_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln232_fu_138_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    add_ln1560_fu_126_p2 <= std_logic_vector(unsigned(data_count_V) + unsigned(ap_const_lv8_1));
    add_ln232_fu_138_p2 <= std_logic_vector(unsigned(data_count_V) + unsigned(ap_const_lv8_48));
    ...
    begin
        if ((data_count_V = ap_const_lv8_0)) then 
            ap_phi_mux_output_word_data_V_phi_fu_98_p6 <= ap_const_lv64_FFFFFFFFFFFF;
        elsif ((data_count_V = ap_const_lv8_1)) then 
            ap_phi_mux_output_word_data_V_phi_fu_98_p6 <= ap_const_lv64_FEAE00000000;
    ...
    begin
                ap_predicate_op19_read_state1 <= (not((data_count_V = ap_const_lv8_1)) and not((data_count_V = ap_const_lv8_0)));
    end process;
    ...
    icmp_ln232_fu_132_p2 <= "1" when (unsigned(add_ln1560_fu_126_p2) < unsigned(ap_const_lv8_B9)) else "0";

    in_stream_TDATA_blk_n_assign_proc : process(data_count_V, ap_CS_iter0_fsm_state1, in_stream_TVALID_int_regslice)
    begin
        if ((not((data_count_V = ap_const_lv8_1)) and not((data_count_V = ap_const_lv8_0)) and (ap_const_logic_1 = ap_CS_iter0_fsm_state1))) then 
    ...
    out_stream_TLAST_int_regslice <= "1" when (data_count_V = ap_const_lv8_B8) else "0";
