...
(* CORE_GENERATION_INFO="data_proc_data_proc,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu28dr-ffvg1517-2-e,HLS_INPUT_CLOCK=6.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=2.007000,HLS_SYN_LAT=1,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=11,HLS_SYN_LUT=118,HLS_VERSION=2022_1}" *)
...
wire   [7:0] ret_V_fu_144_p3;
wire   [7:0] add_ln1560_fu_126_p2;
wire   [0:0] icmp_ln232_fu_132_p2;
wire   [7:0] add_ln232_fu_138_p2;
...
always @ (*) begin
    if ((data_count_V == 8'd0)) begin
        ap_phi_mux_output_word_data_V_phi_fu_98_p6 = 64'd281474976710655;
    end else if ((data_count_V == 8'd1)) begin
        ap_phi_mux_output_word_data_V_phi_fu_98_p6 = 64'd280023277764608;
...
always @ (*) begin
    if ((~(data_count_V == 8'd1) & ~(data_count_V == 8'd0) & (1'b1 == ap_CS_iter0_fsm_state1))) begin
...
assign add_ln1560_fu_126_p2 = (data_count_V + 8'd1);

assign add_ln232_fu_138_p2 = (data_count_V + 8'd72);
...
always @ (*) begin
    ap_predicate_op19_read_state1 = (~(data_count_V == 8'd1) & ~(data_count_V == 8'd0));
end
...
assign icmp_ln232_fu_132_p2 = ((add_ln1560_fu_126_p2 < 8'd185) ? 1'b1 : 1'b0);

assign in_stream_TREADY = regslice_both_in_stream_V_data_V_U_ack_in;

assign out_stream_TLAST_int_regslice = ((data_count_V == 8'd184) ? 1'b1 : 1'b0);
